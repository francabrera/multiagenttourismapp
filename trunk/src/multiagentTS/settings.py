...
JS_ROOT = os.path.join(PROJECT_DIR, 'js')
...
SECRET_KEY = '9l=28uv#-d150of5l=-w!i1es4-cn36_-vq8*nt@g0s%-2xatd'
...
INSTALLED_APPS = (
    ...
    'multiagentTS.newsagent',
    'multiagentTS.imageagent',
    'multiagentTS.guideagent',
