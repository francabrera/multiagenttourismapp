...
urlpatterns = patterns('',
    ...
    (r'^image/', include('imageagent.urls')),
    (r'^guide/', include('guideagent.urls')),
    ...
    (r'^js/(?P<path>.*)$', 'django.views.static.serve', {'document_root': settings.JS_ROOT, 'show_indexes': True}),
    (r'^$', include('useragent.urls')),
